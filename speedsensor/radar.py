	...
	def __unpackB(self,buf):
	 try:
	  ...
	  if status1byte & B_SB1_zone_sameboth:
	   self.report.zone = ZONE_AWAY_SAME # or Same/Both ??? Three modes: Closing/Opp, Away/Same, Both. What to do here?
	  else:
	   self.report.zone = ZONE_CLOSING_OPPOSITE
